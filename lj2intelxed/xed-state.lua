...
require "lj2intelxed.obj.xed-address-width-enum" -- generated
require "lj2intelxed.obj.xed-machine-mode-enum" -- generated
...
/// @ingroup INIT
--]]
local function  xed_state_init2(p,
    arg_mmode,
...
/// @ingroup INIT
local function xed_state_zero(p)
